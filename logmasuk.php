...
<div data-role="page" id="page_lokasi">
	...
	<div data-role="panel" id="panel1" data-display="overlay">
		...
		<ul data-role="listview">
		  ...
		  <li><a href="senaraibarang.php">BARANG</a></li>
		</ul>
	</div>
  ...
  <!--content -->
		...
		$( document ).ready(function() {
		  ...
		  $('#log_masuk').click(function(){
				...
				if (username == "" || password == "" ){
					...
					$.ajax({
					type: 'POST',
					url: 'http://www.ppsppa.gov.my/recycle/logmasuk_pengguna.php',
					data: {
					username : $("#username").val(), 
					password : $("#password").val()},
	...
	<div data-role="popup" id="error_ajax" data-dismissible="false" style="max-width:400px;">
		...
		<div role="main" class="ui-content" align="center">     
			...
			<a href="logmasuk.php" class="ui-btn ui-corner-all ui-shadow" data-ajax="false">Login Semula</a>
